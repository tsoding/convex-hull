...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8b73319444c72bba669e3b397ba6eb3b) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/rexim/convex-hull";
          synopsis =
            "A program that calculates and draws Convex Hull of a set of points.";
          description =
            Some
              [
                 OASISText.Para
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\254\173\166\0287*^\147\019N\012\193\204\214^8";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
